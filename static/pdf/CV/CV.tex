...
%		\resitem{Supervised consumer lifetime value model allowing optimization across programs throughout the company, including customer acquisition with projected \$100m revenue impact (NPV).} 
...
\item[] \href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3117054}{\emph{Projecting Confidence: How the Probabilistic Horse Race Confuses \& Demobilizes the Public}}. Westwood, Messing \& Lelkes. 
%(joint-first-author). 
\emph{Journal of Politics, forthcoming}. \\ 
